...
def selectnode(mode="sms"):
    ...
    try:
        clr()
        bann_text()
        max_limit = {"sms": 9999999999999999999999999999999999999999999999999999999999999999999999, "call": 15, "mail": 9999999999999999999999999999999999999999999999999999999999999999999999}
        cc, target = "", ""
        if mode in ["sms", "call"]:
